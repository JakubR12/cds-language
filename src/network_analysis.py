...
flags: -i, --input_file,   default: ../data/assignment4/edges_df.csv, description: str,    description: path to the input_file,
flags: -o, --output_file:  default: ../data/assignment4/output/measures_of_centrality.csv, description: str, path to output_file
...
flags: -pf, --plot_file:   default: ../data/assignment4/viz/network_visualization.png,     description: str, path to plot_file



examples:
  python network_analysis.py -p -l -t 1500 -pf ../data/assignment4/viz/network_visualization_threshold_1500.png
...
ap.add_argument("-i", "--input_file", default = os.path.join("..", "data", "assignment4", "edges_df.csv"), type = str, help = "str, path to input_file")
ap.add_argument("-o", "--output_file",default = os.path.join("..", "data", "assignment4", "output", "measures_of_centrality.csv"), type = str, help = "str, path to output_file")
ap.add_argument("-t", "--threshold", default = 500, type = int, help = "int, the minimum weight threshold")
ap.add_argument("-l", "--graph_labels", default = False ,nargs = "?",const = True,type = bool, help = "bool, whether to plot labels or not") #nargs and const are used for the boolean swithces to work
ap.add_argument("-p", "--plot_network", type = bool, default = False, nargs = "?", const = True, help = "bool, whether to plot  the network or not")
ap.add_argument("-pf", "--plot_file", default = os.path.join("..", "data", "assignment4", "viz","network_visualization.png"), type = str, help = "str, path to plot_file")
...
def main(
  input_file = os.path.join("..", "data", "assignment4", "edges_df.csv"), 
  ...
  Input:
    input_file,   default: ../data/assignment4/edges_df.csv, description: str,    description: path to the input_file,
    output_file:  default: ../data/assignment4/output/measures_of_centrality.csv, description: str, path to output_file
    ...
    plot_file:    default: ../data/assignment4/viz/network_visualization.png,     description: str, path to plot_file
